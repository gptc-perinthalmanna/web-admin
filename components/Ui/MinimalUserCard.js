...
function NewButton({ onClick }) {
  return (
    <div
      className="relative flex items-center justify-center p-2 m-2 transition-all duration-200 bg-gray-200 border-2 rounded-md cursor-pointer hover:bg-gray-100"
      onClick={onClick}
    >
...
MinimalUserCard.NewButton = NewButton;
